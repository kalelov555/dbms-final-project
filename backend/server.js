...
app.get("/home", (req, res) => {
  ...
  .then(value => {
    ...
    for(let i=0; i<3; i++) {
      const [id, bookName, author, description, genre, img] = value.implicitResults[0][i];
...
app.post("/form/add/book", (req, res) => {
  ...
  oracledb.getConnection({
    ...
    `, [book.id, book.bookName, book.author, book.description, book.genre, book.img], {autoCommit: true})
  })
})
